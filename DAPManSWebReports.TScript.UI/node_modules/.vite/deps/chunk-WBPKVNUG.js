...
var Cell = import_react6.default.forwardRef(function(props, ref) {
  ...
  var _React$useContext = import_react6.default.useContext(TableContext_default), rtl = _React$useContext.rtl, hasCustomTreeCol = _React$useContext.hasCustomTreeCol, isTree = _React$useContext.isTree;
  ...
  var handleTreeToggle = (0, import_react6.useCallback)(function(event) {
  ...
  var renderTreeNodeExpandIcon = function renderTreeNodeExpandIcon2() {
    ...
    var expandButton = import_react6.default.createElement(ExpandIconComponent, {
  ...
  var content = wordWrap ? import_react6.default.createElement("div", {
    className: prefix2("wrap")
  }, renderTreeNodeExpandIcon(), renderCell ? renderCell(cellContent) : cellContent) : import_react6.default.createElement(import_react6.default.Fragment, null, renderTreeNodeExpandIcon(), renderCell ? renderCell(cellContent) : cellContent);
  if (removed) {
    return null;
  }
...
var HeaderCell = import_react7.default.forwardRef(function(props, ref) {
  ...
  var _useState = (0, import_react7.useState)((0, import_isNil2.default)(flexGrow) ? width : 0), columnWidth = _useState[0], setColumnWidth = _useState[1];
  ...
  var handleClick = (0, import_react7.useCallback)(function() {
    if (sortable) {
      onSortColumn === null || onSortColumn === void 0 ? void 0 : onSortColumn(dataKey);
    }
  }, [dataKey, onSortColumn, sortable]);
  var handleColumnResizeStart = (0, import_react7.useCallback)(function() {
  ...
  var handleColumnResizeEnd = (0, import_react7.useCallback)(function(nextColumnWidth, cursorDelta) {
  ...
  var renderSortColumn = function renderSortColumn2() {
    if (sortable && !groupHeader) {
      ...
      var sortIcon = renderSortIcon ? renderSortIcon(sortColumn === dataKey ? sortType : void 0) : import_react7.default.createElement(SortIcon, {
  ...
  return import_react7.default.createElement("div", {
    ref,
    className: classes
  }, import_react7.default.createElement(Cell_default, _extends({
    "aria-sort": ariaSort
  }, rest, {
    width,
    dataKey,
  ...
  }), children, renderSortColumn()), resizable ? import_react7.default.createElement(ColumnResizeHandler_default, {
...
function cloneCell(Cell2, props) {
  return import_react8.default.cloneElement(Cell2, props);
}
  ...
  for (var i = 0; i < cells.length; i += 1) {
    ...
    if (groupCount && isHeaderCell) {
      ...
      for (var j = 0; j < groupCount; j += 1) {
        ...
        groupChildren.push(import_react8.default.createElement(HeaderCell_default, {
          key: j,
          left,
          align,
          verticalAlign,
      ...
      nextCells.push(cloneCell(cells[i], {
        width: nextWidth,
        children: import_react8.default.createElement(ColumnGroup_default, {
          width: nextWidth,
          headerHeight,
          header: groupHeader,
          align: groupAlign,
...
function resetLeftForCells(cells, extraWidth) {
  ...
  for (var i = 0; i < cells.length; i++) {
    var cell = cells[i];
    var nextCell = import_react9.default.cloneElement(cell, {
      left,
...
var useUpdateEffect = function useUpdateEffect2(effect, deps) {
  var isMounting = (0, import_react10.useRef)(true);
...
var useIsomorphicLayoutEffect = canUseDOM_default ? import_react11.useLayoutEffect : import_react11.useEffect;
var useIsomorphicLayoutEffect_default = useIsomorphicLayoutEffect;

// node_modules/rsuite-table/es/utils/useUpdateLayoutEffect.js
var useUpdateLayoutEffect = function useUpdateLayoutEffect2(effect, deps) {
  var isMounting = (0, import_react12.useRef)(true);
...
function useClassNames(str, controlled) {
  var _ref = (0, import_react13.useContext)(TableContext_default) || {}, _ref$classPrefix = _ref.classPrefix, contextClassPrefix = _ref$classPrefix === void 0 ? "rs" : _ref$classPrefix;
...
function useControlled(controlledValue, defaultValue) {
  var controlledRef = (0, import_react14.useRef)(false);
  controlledRef.current = controlledValue !== void 0;
  var _useState = (0, import_react14.useState)(defaultValue), uncontrolledValue = _useState[0], setUncontrolledValue = _useState[1];
  var value = controlledRef.current ? controlledValue : uncontrolledValue;
  var setValue = (0, import_react14.useCallback)(function(nextValue) {
  ...
  var flattenColumns = (0, import_flatten.default)(childrenArray).map(function(column) {
    if ((column === null || column === void 0 ? void 0 : column.type) === ColumnGroup_default) {
      ...
      return childColumns.map(function(childColumn, index) {
        ...
        return import_react15.default.cloneElement(childColumn, groupCellProps);
      });
...
var useCellDescriptor = function useCellDescriptor2(props) {
  ...
  var _useState = (0, import_react16.useState)(), cacheData = _useState[0], setCacheData = _useState[1];
  var clearCache = (0, import_react16.useCallback)(function() {
    setCacheData(null);
  }, []);
  var setColumnResizing = (0, import_react16.useCallback)(function(resizing) {
    if (!tableRef.current) {
      return;
    }
    if (resizing) {
  ...
  var initialColumnWidths = (0, import_react16.useRef)({});
  var columnWidths = (0, import_react16.useRef)({});
  ...
  var handleColumnResizeEnd = (0, import_react16.useCallback)(function(columnWidth, _cursorDelta, dataKey, index) {
  ...
  var handleColumnResizeMove = (0, import_react16.useCallback)(function(width, left2, fixed) {
  ...
  var handleColumnResizeStart = (0, import_react16.useCallback)(function(width, left2, fixed) {
    setColumnResizing(true);
    handleColumnResizeMove(width, left2, fixed);
  }, [handleColumnResizeMove, setColumnResizing]);
  var handleSortColumn = (0, import_react16.useCallback)(function(dataKey) {
  ...
  import_react16.default.Children.forEach(columns, function(column, index) {
    if (import_react16.default.isValidElement(column)) {
      ...
      if (showHeader && headerHeight) {
        ...
        headerCells.push(import_react16.default.cloneElement(headerCell, _extends({}, cellProps, headerCellProps)));
      }
      bodyCells.push(import_react16.default.cloneElement(cell, cellProps));
      left += cellWidth;
    }
  });
  var cacheCell = {
...
var useTableDimension = function useTableDimension2(props) {
  ...
  var contentHeight = (0, import_react17.useRef)(0);
  var contentWidth = (0, import_react17.useRef)(0);
  var minScrollY = (0, import_react17.useRef)(0);
  var scrollY = (0, import_react17.useRef)(0);
  var scrollX = (0, import_react17.useRef)(0);
  var minScrollX = (0, import_react17.useRef)(0);
  var tableWidth = (0, import_react17.useRef)(widthProp || 0);
  var tableHeight = (0, import_react17.useRef)(heightProp || 0);
  var columnCount = (0, import_react17.useRef)(0);
  var resizeObserver = (0, import_react17.useRef)();
  var containerResizeObserver = (0, import_react17.useRef)();
  var headerOffset = (0, import_react17.useRef)(null);
  var tableOffset = (0, import_react17.useRef)(null);
  var getRowHeight = (0, import_react17.useCallback)(function(rowData) {
    return typeof rowHeight === "function" ? rowHeight(rowData) : rowHeight;
  }, [rowHeight]);
  var calculateTableContextHeight = (0, import_react17.useCallback)(function() {
  ...
  var setOffsetByAffix = (0, import_react17.useCallback)(function() {
  ...
  var calculateTableContentWidth = (0, import_react17.useCallback)(function() {
  ...
  var calculateTableWidth = (0, import_react17.useCallback)(function(nextWidth) {
  ...
  var calculateTableHeight = (0, import_react17.useCallback)(function(nextHeight) {
  ...
  var setScrollY = (0, import_react17.useCallback)(function(value) {
    scrollY.current = value;
  }, []);
  var setScrollX = (0, import_react17.useCallback)(function(value) {
...
var useTableRows = function useTableRows2(props) {
  ...
  var _useState = (0, import_react18.useState)([]), tableRowsMaxHeight = _useState[0], setTableRowsMaxHeight = _useState[1];
  var tableRows = (0, import_react18.useRef)({});
  ...
  var calculateRowMaxHeight = (0, import_react18.useCallback)(function() {
    if (wordWrap) {
...
var useAffix = function useAffix2(props) {
  ...
  var scrollListener = (0, import_react19.useRef)();
  var handleAffixHorizontalScrollbar = (0, import_react19.useCallback)(function() {
  ...
  var handleAffixTableHeader = (0, import_react19.useCallback)(function() {
  ...
  var handleWindowScroll = (0, import_react19.useCallback)(function() {
...
var useScrollListener = function useScrollListener2(props) {
  ...
  var wheelListener = (0, import_react20.useRef)();
  var touchStartListener = (0, import_react20.useRef)();
  var touchMoveListener = (0, import_react20.useRef)();
  var touchEndListener = (0, import_react20.useRef)();
  var _useState = (0, import_react20.useState)(false), isScrolling = _useState[0], setScrolling = _useState[1];
  var touchX = (0, import_react20.useRef)(0);
  var touchY = (0, import_react20.useRef)(0);
  var disableEventsTimeoutId = (0, import_react20.useRef)(null);
  var isTouching = (0, import_react20.useRef)(false);
  var momentumStartTime = (0, import_react20.useRef)(0);
  var momentumStartY = (0, import_react20.useRef)(0);
  var shouldHandleWheelX = (0, import_react20.useCallback)(function(delta) {
    if (delta === 0 || disabledScroll || loading) {
      return false;
    }
    return true;
  }, [disabledScroll, loading]);
  var shouldHandleWheelY = (0, import_react20.useCallback)(function(delta) {
  ...
  var debounceScrollEndedCallback = (0, import_react20.useCallback)(function() {
    disableEventsTimeoutId.current = null;
    flushSync_default(function() {
      return setScrolling(false);
    });
  }, []);
  var handleWheel = (0, import_react20.useCallback)(function(deltaX, deltaY, momentumOptions, event) {
    if (!tableRef.current) {
      return;
    }
  ...
  var onWheel = (0, import_react20.useCallback)(function(deltaX, deltaY, momentumOptions) {
  ...
  var wheelHandler = (0, import_react20.useRef)();
  var stopScroll = (0, import_react20.useCallback)(function() {
  ...
  var onScrollBody = (0, import_react20.useCallback)(function(event) {
  ...
  var getControlledScrollTopValue = (0, import_react20.useCallback)(function(value) {
    if (autoHeight) {
      return [0, 0];
    }
  ...
  var releaseListeners = (0, import_react20.useCallback)(function() {
  ...
  var onScrollByKeydown = (0, import_react20.useCallback)(function(event) {
  ...
  var onScrollHorizontal = (0, import_react20.useCallback)(function(delta) {
    return handleWheel(delta, 0);
  }, [handleWheel]);
  var onScrollVertical = (0, import_react20.useCallback)(function(delta, event) {
...
var usePosition = function usePosition2(props) {
  ...
  var duration = (0, import_react21.useRef)(0);
  var bezier = (0, import_react21.useRef)("linear");
  var getScrollCellGroups = (0, import_react21.useCallback)(function() {
    var _tableRef$current;
  ...
  var getFixedLeftCellGroups = (0, import_react21.useCallback)(function() {
  ...
  var getFixedRightCellGroups = (0, import_react21.useCallback)(function() {
  ...
  var updateWheelElementPosition = (0, import_react21.useCallback)(function(fixedCell) {
  ...
  var updatePositionByFixedCell = (0, import_react21.useCallback)(function() {
    var wheelGroupStyle = {};
  ...
  var updatePosition = (0, import_react21.useCallback)(function(nextDuration, nextBezier) {
    if (nextDuration) {
...
var Row = import_react22.default.forwardRef(function(props, ref) {
  ...
  return import_react22.default.createElement("div", _extends({
    role: "row"
  }, rest, {
...
var CellGroup = import_react23.default.forwardRef(function(props, ref) {
  ...
  var _useContext = (0, import_react23.useContext)(TableContext_default), translateDOMPositionXY3 = _useContext.translateDOMPositionXY;
  var _useClassNames = useClassNames_default(classPrefix), withClassPrefix = _useClassNames.withClassPrefix, merge2 = _useClassNames.merge;
  ...
  return import_react23.default.createElement("div", _extends({}, rest, {
    ref,
    className: classes,
    style: styles
  }), children);
...
var Scrollbar = import_react24.default.forwardRef(function(props, ref) {
  ...
  var _React$useContext = import_react24.default.useContext(TableContext_default), translateDOMPositionXY3 = _React$useContext.translateDOMPositionXY;
  var _useState = (0, import_react24.useState)(false), handlePressed = _useState[0], setHandlePressed = _useState[1];
  var _useState2 = (0, import_react24.useState)({
    top: 0,
    left: 0
  }), barOffset = _useState2[0], setBarOffset = _useState2[1];
  var scrollOffset = (0, import_react24.useRef)(0);
  var scrollRange = (0, import_react24.useRef)(scrollLength);
  var barRef = (0, import_react24.useRef)(null);
  var handleRef = (0, import_react24.useRef)(null);
  var mouseMoveTracker = (0, import_react24.useRef)();
  var _useClassNames = useClassNames_default(classPrefix), withClassPrefix = _useClassNames.withClassPrefix, merge2 = _useClassNames.merge, prefix2 = _useClassNames.prefix;
  var classes = merge2(
    className,
    withClassPrefix({
  ...
  var updateScrollBarPosition = (0, import_react24.useCallback)(function(delta, forceDelta, momentum3) {
  ...
  var handleScroll = (0, import_react24.useCallback)(function(delta, event) {
  ...
  var releaseMouseMoves = (0, import_react24.useCallback)(function() {
    var _mouseMoveTracker$cur, _mouseMoveTracker$cur2;
    (_mouseMoveTracker$cur = mouseMoveTracker.current) === null || _mouseMoveTracker$cur === void 0 ? void 0 : (_mouseMoveTracker$cur2 = _mouseMoveTracker$cur.releaseMouseMoves) === null || _mouseMoveTracker$cur2 === void 0 ? void 0 : _mouseMoveTracker$cur2.call(_mouseMoveTracker$cur);
    mouseMoveTracker.current = null;
  }, []);
  var handleDragMove = (0, import_react24.useCallback)(function(deltaX, deltaY, event) {
  ...
  var handleDragEnd = (0, import_react24.useCallback)(function() {
    releaseMouseMoves();
    setHandlePressed(false);
  }, [releaseMouseMoves]);
  var getMouseMoveTracker = (0, import_react24.useCallback)(function() {
    return mouseMoveTracker.current || new DOMMouseMoveTracker_default(handleDragMove, handleDragEnd, document.body);
  }, [handleDragEnd, handleDragMove]);
  var handleMouseDown = (0, import_react24.useCallback)(function(event) {
    var _mouseMoveTracker$cur3;
    mouseMoveTracker.current = getMouseMoveTracker();
  ...
  return import_react24.default.createElement("div", _extends({
    role: "scrollbar",
...
var MouseArea = import_react25.default.forwardRef(function(props, ref) {
...
var Loader = import_react26.default.forwardRef(function(props, ref) {
...
var EmptyMessage = import_react27.default.forwardRef(function(props, ref) {
  var addPrefix = props.addPrefix, locale = props.locale, renderEmpty = props.renderEmpty, loading = props.loading;
  if (loading) {
    return null;
  }
  var emptyMessage = import_react27.default.createElement("div", {
    ref,
...
var flattenChildren = function flattenChildren2(children, flattened) {
  if (flattened === void 0) {
    flattened = [];
  }
  for (var _iterator = _createForOfIteratorHelperLoose(import_react28.default.Children.toArray(children)), _step; !(_step = _iterator()).done; ) {
    var child = _step.value;
    if (ReactIS.isFragment(child)) {
      var _childEl$props;
      var childEl = child;
      if ((_childEl$props = childEl.props) !== null && _childEl$props !== void 0 && _childEl$props.children) {
        flattenChildren2(childEl.props.children, flattened);
      }
    } else {
...
var Table = import_react29.default.forwardRef(function(props, ref) {
  ...
  var children = (0, import_react29.useMemo)(function() {
    return flattenChildren((0, import_isFunction2.default)(getChildren) ? getChildren(getChildrenProps) : getChildren);
  }, [getChildren]);
  ...
  var _useReducer = (0, import_react29.useReducer)(function(x) {
    return x + 1;
  ...
  var translateDOMPositionXY3 = (0, import_react29.useRef)(getTranslateDOMPositionXY({
  ...
  var visibleRows = (0, import_react29.useRef)([]);
  var mouseAreaRef = (0, import_react29.useRef)(null);
  var tableRef = (0, import_react29.useRef)(null);
  var tableHeaderRef = (0, import_react29.useRef)(null);
  var affixHeaderWrapperRef = (0, import_react29.useRef)(null);
  var headerWrapperRef = (0, import_react29.useRef)(null);
  var tableBodyRef = (0, import_react29.useRef)(null);
  var wheelWrapperRef = (0, import_react29.useRef)(null);
  var scrollbarXRef = (0, import_react29.useRef)(null);
  var scrollbarYRef = (0, import_react29.useRef)(null);
  ...
  var colCounts = (0, import_react29.useRef)((headerCells === null || headerCells === void 0 ? void 0 : headerCells.length) || 0);
  useUpdateEffect_default(function() {
  ...
  var renderRowExpanded = (0, import_react29.useCallback)(function(rowData) {
    var height2 = 0;
  ...
  var renderRow = function renderRow2(props2, cells, shouldRenderExpandedRow2, rowData) {
    ...
    if (shouldFixedColumn && contentWidth.current > tableWidth.current) {
      ...
      rowNode = import_react29.default.createElement(import_react29.default.Fragment, null, fixedLeftCellGroupWidth ? import_react29.default.createElement(CellGroup_default, {
        fixed: "left",
      ...
      }, mergeCells_default(resetLeftForCells(fixedLeftCells))) : null, import_react29.default.createElement(CellGroup_default, null, mergeCells_default(scrollCells)), fixedRightCellGroupWidth ? import_react29.default.createElement(CellGroup_default, {
        fixed: "right",
        style: rtl ? {
          right: 0 - rowRight
        } : {
      ...
      rowNode = import_react29.default.createElement(import_react29.default.Fragment, null, import_react29.default.createElement(CellGroup_default, null, mergeCells_default(cells)), shouldRenderExpandedRow2 && renderRowExpanded(rowData));
    }
    return import_react29.default.createElement(Row_default, _extends({}, restRowProps, {
      "data-depth": depth,
      style: rowStyles
  ...
  var renderTableHeader = function renderTableHeader2(headerCells2, rowWidth2) {
    ...
    var header = import_react29.default.createElement("div", {
      className: prefix2("affix-header"),
      style: fixedStyle,
      ref: affixHeaderWrapperRef
    }, renderRow(rowProps, headerCells2));
    return import_react29.default.createElement(import_react29.default.Fragment, null, (affixHeader === 0 || affixHeader) && header, import_react29.default.createElement("div", {
      role: "rowgroup",
      className: prefix2("header-row-wrapper"),
      ref: headerWrapperRef
    }, renderRow(rowProps, headerCells2)));
  };
  var shouldRenderExpandedRow = (0, import_react29.useCallback)(function(rowData) {
  ...
  var bindRowClick = (0, import_react29.useCallback)(function(rowData) {
    return function(event) {
      onRowClick === null || onRowClick === void 0 ? void 0 : onRowClick(rowData, event);
    };
  }, [onRowClick]);
  var bindRowContextMenu = (0, import_react29.useCallback)(function(rowData) {
    return function(event) {
      onRowContextMenu === null || onRowContextMenu === void 0 ? void 0 : onRowContextMenu(rowData, event);
    };
  }, [onRowContextMenu]);
  var handleTreeToggle = (0, import_react29.useCallback)(function(treeRowKey, _rowIndex, rowData) {
    var open = false;
  ...
  var rowSpanState = (0, import_react29.useRef)({});
  var renderRowData = function renderRowData2(bodyCells2, rowData, props2, shouldRenderExpandedRow2) {
    ...
    for (var i = 0; i < bodyCells2.length; i++) {
      ...
      cells.push(import_react29.default.cloneElement(cell, {
        hasChildren,
        rowData,
  ...
  var renderScrollbar = function renderScrollbar2() {
    ...
    if (hasHorizontalScrollbar) {
      scrollbars.push(import_react29.default.createElement(Scrollbar_default, {
        key: "scrollbar",
        tableId: id,
        style: {
          width: tableWidth.current
  ...
  var renderTableBody = function renderTableBody2(bodyCells2, rowWidth2) {
    ...
    return import_react29.default.createElement("div", {
      ...
      ref: wheelWrapperRef
    }, topHideHeight ? import_react29.default.createElement(Row_default, {
      style: topRowStyles,
      className: "virtualized"
    }) : null, visibleRows.current, bottomHideHeight ? import_react29.default.createElement(Row_default, {
      style: bottomRowStyles,
      className: "virtualized"
    }) : null), import_react29.default.createElement(EmptyMessage_default, {
      locale,
      renderEmpty,
      addPrefix: prefix2,
      loading: !!((_visibleRows$current = visibleRows.current) !== null && _visibleRows$current !== void 0 && _visibleRows$current.length) || loading
    }), renderScrollbar(), import_react29.default.createElement(Loader_default, {
      locale,
      loadAnimation,
      loading,
      addPrefix: prefix2,
  ...
  var contextValue = import_react29.default.useMemo(function() {
    return {
      classPrefix,
  ...
  return import_react29.default.createElement(TableContext_default.Provider, {
    value: contextValue
  }, import_react29.default.createElement("div", _extends({
  ...
  }), showHeader && renderTableHeader(headerCells, rowWidth), children && renderTableBody(bodyCells, rowWidth), showHeader && import_react29.default.createElement(MouseArea_default, {
    ref: mouseAreaRef,
    addPrefix: prefix2,
    headerHeight,
    height: getTableHeight()
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WBPKVNUG.js.map
